...
- **Soft leave (reversible)** — Distinct from anonymisation, you can mark a publisher as having left the congregation. They disappear from publisher-facing lists immediately; their data stays. Use this when someone moves away or steps back. Anonymise later if you decide to permanently erase identifying information.
