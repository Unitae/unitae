        ...
        <Body className="mx-auto my-auto bg-white px-2 font-sans">
          <Container className="mx-auto my-[40px] max-w-[465px] rounded border border-[#eaeaea] border-solid p-[20px]">
            <Heading className="mx-0 my-[30px] p-0 text-center font-normal text-[24px] text-black">
              Les administrateurs demandent la <strong>réinitialisation</strong> de votre <strong>mot de passe</strong>.
            </Heading>
            <Section>
              <Text>Bonjour {firstname ?? email},</Text>
              <Text>
                Veuillez réinitialiser votre mot de passe en cliquant sur le lien suivant pour pouvoir accèder à la
                plateforme :{' '}
                <Link
                  href={resetLink}
