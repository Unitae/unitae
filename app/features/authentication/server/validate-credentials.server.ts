...
// Exported so a unit test can prove it stays well-formed (a malformed decoy makes
// `compare` reject before scrypt, silently reintroducing the timing oracle).
export const DECOY_HASH =
  'a3f1c9e0b7d24856a3f1c9e0b7d24856.476ba733127aa020464321f8c35c29c0e8976548860928bc0e35869025ffca23'
