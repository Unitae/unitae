...
): Array<{ section: string; parts: PartAssignment[] }> {
                        ...
                        <div className="flex flex-wrap gap-3 text-xs">
                          <span>
                            <span className="text-muted-foreground">
                              {m.board_dynamic_programme_assignee()}{" "}
                            </span>
                            <span className="font-medium">
                              {formatName(part.assignee)}
                            </span>
                          </span>
                          {part.assistant && (
                            <span>
                              <span className="text-muted-foreground">
                                {m.board_dynamic_programme_assistant()}{" "}
                              </span>
                              <span className="font-medium">
                                {formatName(part.assistant)}
                              </span>
                            </span>
                          )}
                        </div>
