...
export const programsRoutes = [
  ...prefix('programs', [
    ...
    route('bulk-release', 'features/events/routes/programs/bulk-release.tsx'),
    route('bulk-unrelease', 'features/events/routes/programs/bulk-unrelease.tsx'),
    ...
    ...prefix('events/:eventId', [
      ...
      route('release', 'features/events/routes/programs/events/release.tsx'),
      route('unrelease', 'features/events/routes/programs/events/unrelease.tsx'),
