...
const HELP = [
  ...
  },
  {
    ...
    body:
      'Toutes les personnes d’une même case ont les mêmes autorisations, quelle que soit leur fonction — ' +
      'responsable, adjoint ou membre. Si une équipe a besoin d’accès différents, créez-lui une case en dessous ' +
      'avec ses propres autorisations. Les autorisations se règlent dans Réglages → Autorisations, jamais depuis ' +
      'l’organigramme. Les listes des anciens et des assistants, ainsi que le comité de service, se remplissent ' +
      'automatiquement.',
  },
] as const
